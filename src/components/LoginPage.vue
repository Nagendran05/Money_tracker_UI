  ...
  <div class="flex items-center justify-center min-h-screen bg-linear-to-br from-indigo-900 via-blue-700 to-cyan-400">
    ...
    <div class="w-87.5  p-8 rounded-xl  text-center items-center justify-center">
      ...
      <form @submit.prevent="login" class="space-y-4">
        ...
        <div>
          <input type="text" v-model="email" placeholder="Enter Email" required class="w-full px-4 py-2 text-white border border-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-400"/>
        </div>

        <div>
          <input type="password" v-model="password" placeholder="Enter Password" required class="w-full px-4 py-2 text-white border border-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-400"/>
        </div>
        ...
        <button type="submit" :disabled="loading" class="w-full py-2 font-semibold text-white transition duration-300 bg-blue-700 rounded-xl">
